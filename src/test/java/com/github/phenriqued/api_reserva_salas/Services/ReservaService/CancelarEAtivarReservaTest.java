...
class CancelarEAtivarReservaTest {
    ...
    void naoDeveriaCancelarReservaQuandoEstaConcluida() {
        ...
        Exception exception = assertThrows(BusinessRuleException.class, () -> reservaService.cancelarReserva(1L));
    ...
    void reativarReserva() {
        ...
        reservaService.reativarReserva(1L);
    ...
    void naoDeveriaReativarReservaQuandoStatusReservaAtivaOuConcluida() {
        ...
        Exception exception = assertThrows(BusinessRuleException.class, () -> reservaService.reativarReserva(1L));
